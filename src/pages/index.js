...
// import TimelineSection from '../containers/Timeline'
import ExpertiseSection from '../containers/Expertise'
import ExperienceSection from '../containers/Experience'
import PlaySection from '../containers/Play'
...
import AnimatedCanvasThingo from '../components/AnimatedCanvasThingo'
  ...
  return (
    <React.Fragment>
      <section id="home" className="hero is-primary is-bold is-fullheight">
            ...
            <div className="columns">
              <div className="column is-two-thirds">
                <QueueAnim delay={450} style={{ height: 255 }}>
                  ...
                  >
                    Helping start-ups and small bussinesses achieve performant
                    websites with an amazing user experience.
                  </Texty>
                  <QueueAnim
                    key="main-button"
                    delay={3000}
        ...
        >
          <path
            d="M0 0 L0 100 L50 100 Z"
            fill="whitesmoke"
            stroke="whitesmoke"
          ></path>
          <path
            d="M100 0 L100 100 L50 100 Z"
            fill="whitesmoke"
            stroke="whitesmoke"
          ></path>
        </svg>
